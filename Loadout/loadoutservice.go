...
// skill rows hash == skill1; display names live in the embedded sigils.lang.json
...
// of the embedded sigils.lang.json.
//
...
// sliced out of the embedded chara.lang.json. 键就是 sigils.chara.json 的 player，
