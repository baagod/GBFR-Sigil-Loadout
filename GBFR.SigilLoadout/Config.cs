...
/// <summary>
/// The mod's sigiledits.json. Written by the editor tool (SigilLoadout.exe), read here at
/// startup.
///
...
public class Config
{
    ...
    /// <c>SigilEditorFeature.LoadConfig</c>, which logs the reason and then writes nothing
